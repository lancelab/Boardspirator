...
( function () {	 	var tp		=  $.fn.tp$  =  $.fn.tp$ || {};	
		...
		gio.session.init.entry = function() {
			...
			$('.score').attr( 'title',
					'Creativity metric of best map, whirps.' ).attr('target',
					'_blank').attr( 'href', 'creativity_indices.htm' );

			$('.game_score').each( function () {
				$( this ).attr( 'title',  'Game Score. ' + $( this ).attr( 'title' ) );
			});
		};
