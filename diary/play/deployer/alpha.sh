...
DEPLOYED_UNITS="def doc prod tp core google_apps"
...
#. Yes, this is not clean solution. Creates duplicate files. TODM do make single. Perhaps in .htaccess.
cp -f index_prod.htm $ALPHA
cp -f deployer/htacces_for_php_site/.htaccess $ALPHA
