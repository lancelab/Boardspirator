(function( $ ){ 	var tp  =  $.fn.tp$  =  $.fn.tp$ || {};	
	...
	game.path ='games/doubleban';
	game.collections=[
		{	path: 'sokoban/kirillov/doubleban.txt', title:'Intro' },
	...
	//==================================================
	game.DEEPNESS_LIMIT=2; //how many boxes can be pushed
	game.interact=
	{
	...
	game.init_help=function()
	{
		...
		game.rules=
		"robot cannot pull boxes, but can push one or two boxes.";

		game.objective="push all boxes into black cells";

		game.story=
		"Our hero has gained the double power ... can push two boxes at once ...";
