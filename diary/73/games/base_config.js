(function( $ ){ 	var tp  =  $.fn.tp$  =  $.fn.tp$ || {};	
	...
	gio.base_settings={
		...
		*/
		...
		interact_rules	:{
			...
			blocks				:{}, //does block unconditionally; does not depend on policy or imatrix
			neutral				:{ground_x:true}, //unconditional; does not depend on policy or imatrix
			non_blocks			:{}  //excepts from blocking policy; processed only after imatrix
		},
	...
	///////////////////////////////////////////////////////////////////////
		...
		download_collection		: function(){ gio.download_collection(this); },
		//-------------------------------------
		// maps.
		//=====================================
	...
	(function(game){
		...
		game.wall_map_symbols=['y','j','k','l','m','n','o','p','q','r'];
		...
		(function(){
			...
			var neutral=game.interact_rules.neutral;
			var blocks=game.interact_rules.blocks;
			for(var i=0; i<colors.length; i++){
				...
				itr[b][g]='neutral';				//ground of the same color passes movement

				if(i)itr[hero[0]][b]='push';		//blackhero can push every box

				neutral[t]=true;					//targets block nothing

				//blocks[llaw]=true;				//by default all walls do blocking by policy

				game.activity_role[t]='frozen';
				game.activity_role[g]='frozen';
